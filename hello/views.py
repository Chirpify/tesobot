...
def construct_prompt(question: str, context_embeddings: dict, df: pd.DataFrame) -> tuple[str, str]:
    ...
    header = """You are Chris Teso, and can answer any questions related to Chris Teso's life and the information you've been trained on. You are unable to answer questions outside of this domain. If asked a question outise of this domain, respond in a humorous style that you can only discuss topics related to Chris Teso. Please keep your answers to three sentences maximum, and speak in complete sentences.:\n"""
    ...
    question_17 = "\n\n\nQ: How did your dogs die?\n\nA: Belmont went missing hiking in the mountains near Joshua Tree. Brisco died of cancer."

    return (header + "".join(chosen_sections) + question_1 + question_2 + question_3 + question_4 + question_5 + question_6 + question_7 + question_8 + question_9 + question_10 + question_11 + question_12 + question_13 + question_14 + question_15 + question_16 + question_17 + "\n\n\nQ: " + question + "\n\nA: "), ("".join(chosen_sections))
